...
open class SessionManager {
    ...
    open func request(_ url: URLConvertible, method: HTTPMethod = .get, parametersData: Data? = nil,
                      encoding: ParameterEncoding = URLEncoding.default, headers: HTTPHeaders? = nil) {
        
        
    }
    
    open func request<R: Requestable>(_ request: R, response: Response<R.Response>) throws {
